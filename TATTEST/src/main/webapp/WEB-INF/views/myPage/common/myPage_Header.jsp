               ...
               <div class="navbar navbar-default navbar-static-top" role="navigation">
                  ...
                  <div class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a href="${pageContext.request.contextPath}/main/Upgrade.tat" target="_blank">프리미엄</a></li>
         ...
         <div class="modal-body">
           <form id="createProject" action="${pageContext.request.contextPath}/my/createProject.tat">
             <div class="form-group">
               ...
               <input type="text" class="form-control" id="proj_name" name="proj_name" maxlength="15">
             </div>
             <div class="form-group">
               <label for="message-text" class="col-form-label">프로젝트 설명</label>
               <textarea class="form-control" id="proj_comment"  name="proj_comment" maxlength="500" placeholder="최대 500자까지 가능" style="resize: none; height:300px;"></textarea>
             </div>
           </form>
         </div>
