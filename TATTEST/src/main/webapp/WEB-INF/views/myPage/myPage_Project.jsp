                   ...
                   <div class="item">
                       <div class="blog-item">
                           <div class="ImageWrapper">
                               <img src="${pageContext.request.contextPath}/resources/images/portfolio/project${status.index+1}.jpg" alt="" class="img-responsive">
                           </div>
                           <div class="metaInfo">
                           ...
                           <div class="blog-title">
                               <h2><a href="#" title="">${p.proj_name}</a></h2>
                           </div><!-- end title -->
                           ...
                           <div class="blog-button">
                               <a class="btn btn-small btn-default" href="${pageContext.request.contextPath}/my/ProjectDetail.tat?e_code=${p.e_code}&img=${status.index+1}">상세 보기</a>
