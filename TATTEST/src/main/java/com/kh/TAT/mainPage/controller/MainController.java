...
public class MainController {
   ...
   // 둘러보기 댓글 개수순 정렬
      ...
      public ModelAndView ReplyCount(Edit ed){
   ...
   public ModelAndView insertEditReply(EditReplyBoard er,  HttpServletRequest request, Edit edit,
      ...
      */
      ...
      edit.setE_code(er.getE_code());
      edit.setM_code(er.getM_code());
   ...
   public ModelAndView insertReply(TemplateReplyBoard ter, HttpServletRequest request,
         @RequestParam String tr_reply, @RequestParam int tr_rate, TemplateReplyBoard tempReply, Template temp){
